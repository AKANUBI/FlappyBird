...
module lab8_soc_mm_interconnect_0 (
		...
		output wire [1:0]  space_trigger_s1_address,                       //                         space_trigger_s1.address
		output wire        space_trigger_s1_write,                         //                                         .write
		input  wire [31:0] space_trigger_s1_readdata,                      //                                         .readdata
		output wire [31:0] space_trigger_s1_writedata,                     //                                         .writedata
		output wire        space_trigger_s1_chipselect,                    //                                         .chipselect
	...
	wire   [31:0] space_trigger_s1_agent_m0_readdata;                                                 // space_trigger_s1_translator:uav_readdata -> space_trigger_s1_agent:m0_readdata
	wire          space_trigger_s1_agent_m0_waitrequest;                                              // space_trigger_s1_translator:uav_waitrequest -> space_trigger_s1_agent:m0_waitrequest
	wire          space_trigger_s1_agent_m0_debugaccess;                                              // space_trigger_s1_agent:m0_debugaccess -> space_trigger_s1_translator:uav_debugaccess
	wire   [28:0] space_trigger_s1_agent_m0_address;                                                  // space_trigger_s1_agent:m0_address -> space_trigger_s1_translator:uav_address
	wire    [3:0] space_trigger_s1_agent_m0_byteenable;                                               // space_trigger_s1_agent:m0_byteenable -> space_trigger_s1_translator:uav_byteenable
	wire          space_trigger_s1_agent_m0_read;                                                     // space_trigger_s1_agent:m0_read -> space_trigger_s1_translator:uav_read
	wire          space_trigger_s1_agent_m0_readdatavalid;                                            // space_trigger_s1_translator:uav_readdatavalid -> space_trigger_s1_agent:m0_readdatavalid
	wire          space_trigger_s1_agent_m0_lock;                                                     // space_trigger_s1_agent:m0_lock -> space_trigger_s1_translator:uav_lock
	wire   [31:0] space_trigger_s1_agent_m0_writedata;                                                // space_trigger_s1_agent:m0_writedata -> space_trigger_s1_translator:uav_writedata
	wire          space_trigger_s1_agent_m0_write;                                                    // space_trigger_s1_agent:m0_write -> space_trigger_s1_translator:uav_write
	wire    [2:0] space_trigger_s1_agent_m0_burstcount;                                               // space_trigger_s1_agent:m0_burstcount -> space_trigger_s1_translator:uav_burstcount
	wire          space_trigger_s1_agent_rf_source_valid;                                             // space_trigger_s1_agent:rf_source_valid -> space_trigger_s1_agent_rsp_fifo:in_valid
	wire  [107:0] space_trigger_s1_agent_rf_source_data;                                              // space_trigger_s1_agent:rf_source_data -> space_trigger_s1_agent_rsp_fifo:in_data
	wire          space_trigger_s1_agent_rf_source_ready;                                             // space_trigger_s1_agent_rsp_fifo:in_ready -> space_trigger_s1_agent:rf_source_ready
	wire          space_trigger_s1_agent_rf_source_startofpacket;                                     // space_trigger_s1_agent:rf_source_startofpacket -> space_trigger_s1_agent_rsp_fifo:in_startofpacket
	wire          space_trigger_s1_agent_rf_source_endofpacket;                                       // space_trigger_s1_agent:rf_source_endofpacket -> space_trigger_s1_agent_rsp_fifo:in_endofpacket
	wire          space_trigger_s1_agent_rsp_fifo_out_valid;                                          // space_trigger_s1_agent_rsp_fifo:out_valid -> space_trigger_s1_agent:rf_sink_valid
	wire  [107:0] space_trigger_s1_agent_rsp_fifo_out_data;                                           // space_trigger_s1_agent_rsp_fifo:out_data -> space_trigger_s1_agent:rf_sink_data
	wire          space_trigger_s1_agent_rsp_fifo_out_ready;                                          // space_trigger_s1_agent:rf_sink_ready -> space_trigger_s1_agent_rsp_fifo:out_ready
	wire          space_trigger_s1_agent_rsp_fifo_out_startofpacket;                                  // space_trigger_s1_agent_rsp_fifo:out_startofpacket -> space_trigger_s1_agent:rf_sink_startofpacket
	wire          space_trigger_s1_agent_rsp_fifo_out_endofpacket;                                    // space_trigger_s1_agent_rsp_fifo:out_endofpacket -> space_trigger_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_013_src_valid;                                                              // cmd_mux_013:src_valid -> space_trigger_s1_agent:cp_valid
	wire  [106:0] cmd_mux_013_src_data;                                                               // cmd_mux_013:src_data -> space_trigger_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                              // space_trigger_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [14:0] cmd_mux_013_src_channel;                                                            // cmd_mux_013:src_channel -> space_trigger_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                                      // cmd_mux_013:src_startofpacket -> space_trigger_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                        // cmd_mux_013:src_endofpacket -> space_trigger_s1_agent:cp_endofpacket
	...
	wire  [107:0] random_num_s1_agent_rf_source_data;                                                 // random_num_s1_agent:rf_source_data -> random_num_s1_agent_rsp_fifo:in_data
	...
	wire  [107:0] random_num_s1_agent_rsp_fifo_out_data;                                              // random_num_s1_agent_rsp_fifo:out_data -> random_num_s1_agent:rf_sink_data
	...
	wire          cmd_mux_014_src_valid;                                                              // cmd_mux_014:src_valid -> random_num_s1_agent:cp_valid
	wire  [106:0] cmd_mux_014_src_data;                                                               // cmd_mux_014:src_data -> random_num_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                              // random_num_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [14:0] cmd_mux_014_src_channel;                                                            // cmd_mux_014:src_channel -> random_num_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                                      // cmd_mux_014:src_startofpacket -> random_num_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                        // cmd_mux_014:src_endofpacket -> random_num_s1_agent:cp_endofpacket
	...
	wire          space_trigger_s1_agent_rp_valid;                                                    // space_trigger_s1_agent:rp_valid -> router_015:sink_valid
	wire  [106:0] space_trigger_s1_agent_rp_data;                                                     // space_trigger_s1_agent:rp_data -> router_015:sink_data
	wire          space_trigger_s1_agent_rp_ready;                                                    // router_015:sink_ready -> space_trigger_s1_agent:rp_ready
	wire          space_trigger_s1_agent_rp_startofpacket;                                            // space_trigger_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          space_trigger_s1_agent_rp_endofpacket;                                              // space_trigger_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          random_num_s1_agent_rp_valid;                                                       // random_num_s1_agent:rp_valid -> router_016:sink_valid
	wire  [106:0] random_num_s1_agent_rp_data;                                                        // random_num_s1_agent:rp_data -> router_016:sink_data
	wire          random_num_s1_agent_rp_ready;                                                       // router_016:sink_ready -> random_num_s1_agent:rp_ready
	wire          random_num_s1_agent_rp_startofpacket;                                               // random_num_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          random_num_s1_agent_rp_endofpacket;                                                 // random_num_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire          space_trigger_s1_agent_rdata_fifo_src_valid;                                        // space_trigger_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_013:in_0_valid
	wire   [33:0] space_trigger_s1_agent_rdata_fifo_src_data;                                         // space_trigger_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_013:in_0_data
	wire          space_trigger_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_013:in_0_ready -> space_trigger_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_013_out_0_valid;                                                  // avalon_st_adapter_013:out_0_valid -> space_trigger_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_013_out_0_data;                                                   // avalon_st_adapter_013:out_0_data -> space_trigger_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_013_out_0_ready;                                                  // space_trigger_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_013:out_0_ready
	wire    [0:0] avalon_st_adapter_013_out_0_error;                                                  // avalon_st_adapter_013:out_0_error -> space_trigger_s1_agent:rdata_fifo_sink_error
	wire          random_num_s1_agent_rdata_fifo_src_valid;                                           // random_num_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_014:in_0_valid
	wire   [33:0] random_num_s1_agent_rdata_fifo_src_data;                                            // random_num_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_014:in_0_data
	wire          random_num_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_014:in_0_ready -> random_num_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_014_out_0_valid;                                                  // avalon_st_adapter_014:out_0_valid -> random_num_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_014_out_0_data;                                                   // avalon_st_adapter_014:out_0_data -> random_num_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_014_out_0_ready;                                                  // random_num_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_014:out_0_ready
	wire    [0:0] avalon_st_adapter_014_out_0_error;                                                  // avalon_st_adapter_014:out_0_error -> random_num_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) space_trigger_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (jtag_uart_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (space_trigger_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (space_trigger_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (space_trigger_s1_agent_m0_read),                //                         .read
		.uav_write              (space_trigger_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (space_trigger_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (space_trigger_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (space_trigger_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (space_trigger_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (space_trigger_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (space_trigger_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (space_trigger_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (space_trigger_s1_address),                      //      avalon_anti_slave_0.address
		.av_write               (space_trigger_s1_write),                        //                         .write
		.av_readdata            (space_trigger_s1_readdata),                     //                         .readdata
		.av_writedata           (space_trigger_s1_writedata),                    //                         .writedata
		.av_chipselect          (space_trigger_s1_chipselect),                   //                         .chipselect
		.av_read                (),                                              //              (terminated)
		.av_begintransfer       (),                                              //              (terminated)
		.av_beginbursttransfer  (),                                              //              (terminated)
		.av_burstcount          (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) space_trigger_s1_agent (
		.clk                     (clk_0_clk_clk),                                     //             clk.clk
		.reset                   (jtag_uart_0_reset_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (space_trigger_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (space_trigger_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (space_trigger_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (space_trigger_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (space_trigger_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (space_trigger_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (space_trigger_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (space_trigger_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (space_trigger_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (space_trigger_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (space_trigger_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (space_trigger_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (space_trigger_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (space_trigger_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (space_trigger_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (space_trigger_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (space_trigger_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (space_trigger_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (space_trigger_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (space_trigger_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (space_trigger_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (space_trigger_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (space_trigger_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (space_trigger_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (space_trigger_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (space_trigger_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_013_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_013_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_013_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_013_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (space_trigger_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (space_trigger_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (space_trigger_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                             //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                               //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) space_trigger_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                     //       clk.clk
		.reset             (jtag_uart_0_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (space_trigger_s1_agent_rf_source_data),             //        in.data
		.in_valid          (space_trigger_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (space_trigger_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (space_trigger_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (space_trigger_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (space_trigger_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (space_trigger_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (space_trigger_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (space_trigger_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (space_trigger_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                             // (terminated)
		.csr_read          (1'b0),                                              // (terminated)
		.csr_write         (1'b0),                                              // (terminated)
		.csr_readdata      (),                                                  // (terminated)
	...
	lab8_soc_mm_interconnect_0_router_002 router_015 (
		.sink_ready         (space_trigger_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (space_trigger_s1_agent_rp_valid),               //          .valid
		.sink_data          (space_trigger_s1_agent_rp_data),                //          .data
		.sink_startofpacket (space_trigger_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (space_trigger_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (jtag_uart_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab8_soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                 // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (space_trigger_s1_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (space_trigger_s1_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (space_trigger_s1_agent_rdata_fifo_src_ready),   //         .ready
